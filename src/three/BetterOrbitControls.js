...
const BetterOrbitControls = function (object, domElement) {
...
BetterOrbitControls.prototype = Object.create(THREE.EventDispatcher.prototype)
BetterOrbitControls.prototype.constructor = BetterOrbitControls

Object.defineProperties(BetterOrbitControls.prototype, {
  
  center: {
    
    get: function () {
      
      console.warn('BetterOrbitControls: .center has been renamed to .target')
      return this.target
  ...
  noZoom: {
    ...
    get: function () {
      ...
      console.warn('BetterOrbitControls: .noZoom has been deprecated. Use .enableZoom instead.')
  ...
  noRotate: {
    ...
    get: function () {
      ...
      console.warn('BetterOrbitControls: .noRotate has been deprecated. Use .enableRotate instead.')
  ...
  noPan: {
    ...
    get: function () {
      ...
      console.warn('BetterOrbitControls: .noPan has been deprecated. Use .enablePan instead.')
  ...
  noKeys: {
    ...
    get: function () {
      ...
      console.warn('BetterOrbitControls: .noKeys has been deprecated. Use .enableKeys instead.')
  ...
  staticMoving: {
    ...
    get: function () {
      ...
      console.warn('BetterOrbitControls: .staticMoving has been deprecated. Use .enableDamping instead.')
  ...
  dynamicDampingFactor: {
    ...
    get: function () {
      ...
      console.warn('BetterOrbitControls: .dynamicDampingFactor has been renamed. Use .dampingFactor instead.')
...
export default BetterOrbitControls